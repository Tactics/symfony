...
abstract class sfComponent
{
    ...
    public function logMessage($message, $priority = 'info')
    {
        if (sfConfig::get('sf_logging_enabled')) {
            $this->context->getLogger()->log($message, constant('SF_LOG_'.strtoupper((string) $priority)));
        }
    }
     ...
     * @param  bool true if the flash have to persist for the following request (true by default)
     */
