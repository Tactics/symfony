...
class sfCultureInfo implements Stringable
{
    ...
    {
        if (preg_match('/^[a-z]{2}(_[A-Z]{2,5}){0,2}$/', (string) $culture)) {
    ...
    {
        $file_parts = explode('_', (string) $culture);
     ...
     * @param bool merge the data from its parents
     *
     ...
     */
    protected static function simplify($array)
    {
    ...
    {
        return static::simplify($this->findInfo('Countries', true));
    }
    ...
    {
        return static::simplify($this->findInfo('Languages', true));
    }
    ...
    {
        return static::simplify($this->findInfo('Scripts', true));
    }
    ...
    {
        return static::simplify($this->findInfo('zoneStrings', true));
    }
}
