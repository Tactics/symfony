...
class sfCreoleDatabase extends sfDatabase
{
        ...
        try {
            ...
            switch ($method) {
                case 'normal':
                    ...
                    $dsn = ['database' => $database, 'hostspec' => $hostspec, 'password' => $password, 'phptype' => $phptype, 'username' => $username, 'port' => $port, 'encoding' => $encoding];
                    break;
    ...
    protected function &loadDSN(&$array)
    {
        ...
        if ($dsn == null) {
            ...
            $available = ['database', 'hostspec', 'password', 'phptype', 'username', 'port'];
