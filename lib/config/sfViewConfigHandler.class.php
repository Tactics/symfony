...
class sfViewConfigHandler extends sfYamlConfigHandler
{
    ...
    protected function mergeConfig($myConfig)
    {
        ...
        $myConfig['all']['stylesheets'] = array_merge(isset($myConfig['default']['stylesheets']) && is_array($myConfig['default']['stylesheets']) ? $myConfig['default']['stylesheets'] : [], isset($myConfig['all']['stylesheets']) && is_array($myConfig['all']['stylesheets']) ? $myConfig['all']['stylesheets'] : []);
        unset($myConfig['default']['stylesheets']);

        $myConfig['all']['javascripts'] = array_merge(isset($myConfig['default']['javascripts']) && is_array($myConfig['default']['javascripts']) ? $myConfig['default']['javascripts'] : [], isset($myConfig['all']['javascripts']) && is_array($myConfig['all']['javascripts']) ? $myConfig['all']['javascripts'] : []);
    ...
    protected function addHtmlHead($viewName = '')
    {
        ...
        foreach ($this->mergeConfigValue('metas', $viewName) as $name => $content) {
            $html = htmlspecialchars(is_string($content) ? $content : '', ENT_QUOTES, sfConfig::get('sf_charset'));
