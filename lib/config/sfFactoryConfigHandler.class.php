...
class sfFactoryConfigHandler extends sfYamlConfigHandler
{
    ...
    public function execute($configFiles)
    {
        ...
        $myConfig = sfToolkit::arrayDeepMerge(
            ...
            isset($myConfig[sfConfig::get('sf_environment')]) && is_array($myConfig[sfConfig::get('sf_environment')]) ? $myConfig[sfConfig::get('sf_environment')] : []
        );
        ...
        $factories = ['controller', 'request', 'response', 'storage', 'user', 'view_cache'];
