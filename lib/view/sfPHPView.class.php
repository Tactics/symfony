...
class sfPHPView extends sfView
{
    ...
    protected function getGlobalVars()
    {
        ...
        $shortcuts = ['sf_context' => $context, 'sf_params' => $context->getRequest()->getParameterHolder(), 'sf_request' => $context->getRequest(), 'sf_user' => $context->getUser(), 'sf_view' => $this];
    ...
    public function render($templateVars = null)
    {
        ...
        if ($retval === null) {
            ...
            if (sfConfig::get('sf_cache') && $key !== null) {
                $cache = ['content' => $retval, 'vars' => $templateVars, 'view_name' => $this->viewName, 'response' => $context->getResponse()];
